  ...
  return (
    <main ref={containerRef} className="bg-white text-zinc-900 selection:bg-orange-100">
      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-12">
        ...
        <section className="relative min-h-screen flex flex-col pt-5 pb-20">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-10">
            <div className="max-w-4xl">
              ...
              <h1 className="reveal-up text-[10vw] lg:text-[8.5vw] font-black leading-[0.8] uppercase tracking-tighter">
            ...
            <div className="lg:w-[40vw] space-y-8">
              <p className="reveal-up text-zinc-500 text-lg leading-relaxed font-light">
                {heroData.description}
              </p>
              <div className="reveal-up">
                <Link href={heroData.buttonLink} className="group flex items-center gap-8 py-2 border-b border-zinc-900 w-fit">
          ...
          <div className="hero-image-wrapper relative w-full h-[65vh] overflow-hidden rounded-sm bg-zinc-100">
             <Image 
                ...
                priority 
             />
             <div className="absolute bottom-10 right-10 flex flex-col items-center gap-4 text-white mix-blend-difference">
                <span className="uppercase text-[9px] tracking-[0.5em] [writing-mode:vertical-lr]">Scroll</span>
        ...
        <section className="relative h-[70vh] w-full flex items-center justify-center overflow-hidden mb-12 rounded-sm bg-zinc-50 border border-zinc-100">
           <Image src={featureBanner.imageSrc} alt="Banner" fill className="object-cover opacity-20 grayscale" />
           <div className="relative z-10 text-center space-y-12">
              <h2 className="text-[8vw] font-black uppercase tracking-tighter text-zinc-900">
                {featureBanner.title}
              </h2>
              <button className="px-12 py-5 bg-zinc-900 text-white font-bold uppercase tracking-[0.3em] text-[10px] hover:scale-105 hover:bg-orange-600 cursor-pointer transition-transform active:scale-95">
...
function BentoCard({ data, className }: { data: any, className: string }) {
  return (
    <Link href={data.href} className={`bento-item group relative overflow-hidden bg-zinc-100 rounded-sm border border-transparent hover:border-zinc-200 transition-colors ${className}`}>
      ...
      <div className="absolute bottom-0 left-0 w-full p-8 flex justify-between items-end translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-gradient-to-t from-black/80 to-transparent">
         <div>
            <span className="block text-[9px] font-bold uppercase tracking-widest font-bold text-orange-600 mb-1">{data.subtitle}</span>
