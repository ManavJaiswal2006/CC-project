        ...
        <table width="100%" style="max-width: 600px; background-color: #ffffff; border: 1px solid #eeeeee;">
          ...
          <tr>
            <td style="background-color: #1a1a1a; padding: 50px 40px; text-align: left;">
              <img src="${process.env.NEXT_PUBLIC_SITE_URL || "https://cc-project-phi.vercel.app"}/bourgonLogo.png" alt="Bourgon Industries" style="max-width: 180px; height: auto; margin-bottom: 20px; display: block;" />
