...
<body>
  <div class="wrapper">
    <table class="main" align="center">
      <tr>
        <td class="header">
          <img src="${process.env.NEXT_PUBLIC_SITE_URL || "https://cc-project-phi.vercel.app"}/bourgonLogo.png" alt="Bourgon Industries" style="max-width: 200px; height: auto; margin-bottom: 20px;" />
